...
if [ -x /usr/bin/dircolors ]; then
    ...
    alias fuckyou='sudo apt upgrade -y'
    alias fun='fortune | cowsay | lolcat'
    alias bajame='wget --wait=20 --limit-rate=20K -r -p -U Mozilla  https://'
...
if [ $TILIX_ID ] || [ $VTE_VERSION ] ; then source /etc/profile.d/vte.sh; fi # Ubuntu Budgie END" >> .bashrc
